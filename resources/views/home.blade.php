...
<body class="min-h-screen bg-gray-100">
    ...
    <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
            <div class="flex items-center space-x-4">
                ...
                <form id="searchForm" action="{{ route('inicio') }}" method="GET" class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-3">
                ...
                <img src="https://cdn-icons-png.flaticon.com/512/5968/5968756.png" alt="icon" class="w-8 h-8">
            </div>
        </div>
    </header>
    ...
    <section class="relative bg-gray-900 text-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 items-center">
            <!-- Texto -->
            <div>
                <h1 class="text-4xl font-extrabold uppercase">
                    Bienvenido a <br>
                    <span class="text-gray-300">Tu Ex Market</span>
                </h1>
    ...
    <!-- Contenido -->
    <main class="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <aside class="col-span-1">
            <h2 class="text-xl font-semibold mb-5">Categorías</h2>
            <ul class="space-y-2">
                @foreach (['Categoria 1', 'Categoria 2', 'Categoria 3', 'Categoria 4', 'Categoria 5'] as $cat)
                    <li class="bg-white rounded-lg shadow p-3 hover:bg-gray-100 cursor-pointer">
                        {{ $cat }}
                    </li>
                @endforeach
            </ul>
